...
async def create_user(create_user: CreateUserRequest):
    ...
    try:
        query = "insert into user_data (username, first_name, last_name, sex, body_type, location, country_code) values (%s, %s, %s, %s, %s, %s, %s)"
        params = (
            create_user.username, create_user.first_name, create_user.last_name, create_user.gender,
            create_user.body_type,
            create_user.location, create_user.country_code
        )
